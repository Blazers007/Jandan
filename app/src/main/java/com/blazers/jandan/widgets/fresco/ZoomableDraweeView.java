package com.blazers.jandan.widgets.fresco;
...
public class ZoomableDraweeView extends DraweeView<GenericDraweeHierarchy>
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (mZoomableController.onTouchEvent(event)) {
            ...
            //FLog.v(mID, "onTouchEvent: view %x, handled by zoomable controller", this.hashCode());
            return true;
        }
        //FLog.v(mID, "onTouchEvent: view %x, handled by the super", this.hashCode());
